...
function ChangeText() {
    ...
    const spanish = ['<i class="fas fa-globe"></i> Cambiar Idioma', 'Solar', 'Convierta la luz solar en energía limpia con paneles solares en su tejado existente, o un nuevo techo solar.', 'Una batería de hogar diseñada para almacenar tu energía limpia, para que puedas usarla en cualquier momento que quieras, por la noche o durante una interrupción.', 'Energía'];
